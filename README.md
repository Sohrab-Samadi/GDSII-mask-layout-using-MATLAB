...
This repository is dedicated to generating **GDSII layouts of compact, multi-circuit photonic chips** using the **Raith_GDSII MATLAB Toolbox**, with an emphasis on the **fixed-beam moving-stage (FBMS)** exposure mode.
...
In order to run the codes, you need to place the four class definitions found in the src directory (Raith_element.m, Raith_structure.m, Raith_library.m, and Raith_positionlist.m) into a folder on your MATLAB path. The files are available at https://github.com/ahryciw .
