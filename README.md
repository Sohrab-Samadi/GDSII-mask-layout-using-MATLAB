...
<h1>Interpretation of the Layout and Etch Regions</h1> 
...
<h2>Grating Coupler Isolation (Figure 1)</h2> 
...
<h2>Waveguide Isolation (Figure 2)</h2> 
...
<h2>Motivation for Local Etching</h2> 
...
<h2>Design Goal: Compact Cut-Back Test Structures</h2>
...
<h1>generate_layout_from_workspace.m</h1>
...
To be able to run the codes, you need to put Raith_element.m, Raith_structure.m, Raith_library.m, and Raith_positionlist.m into a folder on your MATLAB path. You can find them on RAITH_GDSII github at [ https://github.com/ahryciw/Raith_GDSII/blob/main/README.md](https://github.com/ahryciw/Raith_GDSII.git)



This reciprocity is for greating GDSII layout of complete photonic circuits, which includes grating couplers, waveguides, bends, and tapered waveguides. The purpose of this layout is to create circuits with the same number of bends but different waveguide lengths to measure the loss of the waveguides through the cut-back method and assess the efficiency of the grating couplers.
The below schematic is the created GDSII layout:

<img width="1714" height="1001" alt="Screenshot (539)" src="https://github.com/user-attachments/assets/9e078abf-bd24-44a5-a36a-5dc7652b8bf7" />

9 compact circuits are generated with this code. The circuits are labeled with their numbers.
The parameters.m code is for defining the geometrical features of each of the circuits. The features of each circuit are defined in different blocks. This contains the cooridinates  
